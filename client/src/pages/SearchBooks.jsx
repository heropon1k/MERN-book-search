...
const SearchBooks = () => {
  ...
  // Set up Apollo mutation for saving books
  const [saveBook] = useMutation(SAVE_BOOK);  // Use Apollo's useMutation for saving books
  ...
  const handleSaveBook = async (bookId) => {
    ...
    try {
      // Use Apollo's saveBook mutation instead of the old API call
